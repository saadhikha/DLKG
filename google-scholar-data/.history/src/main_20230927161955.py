...
def get_paper_details(soup):
    ...
    for result in soup.select('.gs_ri'):
        ...
        title_link_elem = result.select_one('.gs_rt a[href^="http"]')  # 尝试只选择真正的HTTP链接
title = title_link_elem.text if title_link_elem else 'N/A'
link = title_link_elem['href'] if title_link_elem else 'N/A'
